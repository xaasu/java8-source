...
public class Thread implements Runnable {
    ...
    /* 当前线程的ThreadLocal变量，用来存储一些线程独有的变量. */
    ThreadLocal.ThreadLocalMap threadLocals = null;

    /*
     * 从父线程继承过来的threadLocal变量，可用于父子线程传递值
     */
     ...
     * @param millis 毫秒
     * @param nanos  纳秒
     * @throws InterruptedException 线程挂起时抛出
     */
    ...
    public enum State {
        ...
        /**
         * 等待状态，等待唤醒（Object.wait()/Thread.join()/LockSupport.park()后都进入此状态）
         */
        WAITING,

        /**
         * 带超时时间的等待状态，Object.wait(long),Thread.join(long),LockSupport.parkNanos(),LockSupport.parkUntil()之后进入此状态
         */
        TIMED_WAITING,
